...
class MemberNotifications(commands.Cog):
    ...
    @app_commands.command(name="set-member-notification-log", description="Setup Member Notifia")
    ...
    @app_commands.command(name="reset-log-member-notifcation", description="Setup Member Notifiation Reset")
    @commands.has_permissions(administrator=True)
